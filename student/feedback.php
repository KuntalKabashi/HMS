<?php
    ...
    $query="INSERT into feedback(stuId,f_content) values(?,?)";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('ss',$stuId,$f_content);
    $stmt->execute();
            ...
            <div class="col-sm-6 mt-5">
                <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="stuId"><i class="fa-solid fa-graduation-cap"></i>Student Registration No:</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="f_content" name="f_content" row=100 required></textarea>
                        </div>
